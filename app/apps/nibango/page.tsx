...
const legalDocs = [
  {
    ...
    href: '/apps/nibango/privacy',
    updated: '2026-03-30',
  },
  {
    title: 'Terms of Service',
    desc: 'Rules and conditions for using the Nibango platform.',
    href: '/apps/nibango/terms',
    updated: '2026-03-30',
  },
]
      ...
      <section style={{ padding: '10rem 2.5rem 4rem' }}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <span style={{ fontSize: '0.65rem', color: 'var(--lime)', letterSpacing: '0.25em', fontFamily: 'var(--font-syne)', fontWeight: 700 }}>APPS / NIBANGO</span>
          </div>
          ...
          <p style={{ fontFamily: 'var(--font-syne)', fontSize: '1rem', color: 'rgba(240,237,232,0.45)', lineHeight: 1.7, maxWidth: '520px' }}>
            Peer-to-peer second-hand marketplace reimagined for the Gulf. Buy, sell, trust.
          </p>
        </motion.div>
      </section>
